...
public class MazeGenerator : MonoBehaviour
{
    ...
    /// <summary>
    /// This method is called once per frame and is responsible for updating the game logic.
    /// It generates a maze, spawns the grid, and visualizes the path when certain conditions are met.
    /// </summary>
    private void Update()
    {
        if(generate)
